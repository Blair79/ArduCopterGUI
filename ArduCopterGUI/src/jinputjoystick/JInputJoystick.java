...
/**
 * 
 * @author endolf from: http://www.java-gaming.org/index.php/topic,16866.0
 * 
 */
...
public class JInputJoystick {
	...
	public void getAllControllersInfo() {
		...
		for (int i = 0; i < controllersList.length; i++) {
			...
			// see
			// http://www.newdawnsoftware.com/resources/jinput/apidocs/net/java/games/input/Controller.Type.html
			...
			for (int j = 0; j < components.length; j++) {
				...
				// see
				// http://www.newdawnsoftware.com/resources/jinput/apidocs/net/java/games/input/Component.Identifier.html
